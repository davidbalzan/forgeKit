...
- **[Tech Stack](TECH_STACK.md)** - Technology choices with versions, rationale, and upgrade risks
- **[Current Focus](../CURRENT_FOCUS.md)** - What's actively being worked on and current phase
- **[Design System](DESIGN_SYSTEM.md)** - Visual language and component patterns (if frontend)
