...
- **Different frontend** — Replace `apps/web/` contents, update `docs/TECH_STACK.md`
...
See [docs/COMMANDS.md](./docs/COMMANDS.md) for detailed per-IDE usage instructions with examples.
